...
echo "========================================"
echo "  Youkies Browser Linux Publish"
echo "========================================"
echo "Target : $TARGET"
...
mkdir -p "$OUTPUT_DIR"
TAR_NAME="YoukiesBrowser-${VERSION}-linux-${ARCH}.tar.gz"
...
<component type="desktop-application">
  ...
  <description>
    <p>Youkies Browser manages isolated browser profiles, proxy binding, and local environment configuration for multi-account workflows.</p>
...
Description: ${APP_NAME} desktop app
 ...
 Youkies Browser manages isolated browser profiles, proxy binding, and
